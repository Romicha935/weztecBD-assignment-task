    ...
    <nav className=' bg-white fixed py-2 top-0 w-full md:py-4 z-50 shadow'>
        <div className='container relative mx-auto flex justify-between items-center'>
            ...
            <div className='flex gap-4 md:mr-2'>
                ...
                <Link to='/login'><button className='bg-pink-900 py-1.5 px-3 sm:py-2 sm:px-5 rounded-full text-white cursor-pointer text-xs sm:text-sm md:text-base md:mr-10'>Login Now</button></Link>
          

            {/* mobile menu button */}
            <button onClick={()=> setIsMenu(!isMenu)} 
            className='md:hidden px-10  text-2xl text-gray-700 hover:text-pink-700 ml-2'>
